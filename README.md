...
Yub.js is an extensible client-side web command-line that comes with [loads of useful search engines](http://dohliam.github.io/yub/?s google) and shortcuts, reusable commands, and lots of other hidden goodies like [stopwatches](http://dohliam.github.io/yub/?stopwatch) and [inline YouTube videos](http://dohliam.github.io/yub/?watch imax). It also has a flexible API so you can call yub.js commands from anywhere: for example, you can [link directly to commands](http://dohliam.github.io/yub/?echo Hi there, new yubSearch user!<br>Have fun, and type 'help' if you get lost :)), or access them right from your browser address bar (just set up a single search shortcut pointing at the yub.js API, and get hundreds of other search shortcuts for free).

The whole thing was designed from the outset to be a single page standalone html document containing everything needed to work out of the box. Since then it has grown considerably and development has been split into separate, more manageable files. The [standalone html page version](http://dohliam.github.io/yub/) is still available, though it is now automatically generated by a ruby script, and also comes in a [minified version](http://dohliam.github.io/yub/index_min.html). Just save the page directly to your computer or drop it on your server and you're ready to go!

The list of available search engines is completely modular: you can drop in your own list of commonly visited websites by editing or replacing the mods.js file (json). Making your own new commands is easy -- just use the [`create`](http://dohliam.github.io/yub/?man create) command (with the name of the new command as an [optional argument](http://dohliam.github.io/yub/?man create <i>command</i>)). Feel free to add your own new functions or extend existing ones by editing functions.js. Oh, and regular expressions are [supported everywhere by default](http://dohliam.github.io/yub/?s ^gn).
...
* get a list of all available search shortcuts by typing [`list`](http://dohliam.github.io/yub/?list) or [`ls`](http://dohliam.github.io/yub/?ls)
...
* use `g` _searchterm_ for a plain vanilla Google Search. Or you might prefer to use `y`, `b`, `ix`, or `sp` instead
* help is available by typing [`help`](http://dohliam.github.io/yub/?help) or [`man`](http://dohliam.github.io/yub/?man) (optionally including the command you want help with as an argument, e.g. [`help shuffle`](http://dohliam.github.io/yub/?help shuffle))

### More Examples

* [`calc 857*2^3`](http://dohliam.github.io/yub/?calc%20857*2%5E3)	solve simple mathematical formulas
* [`calc (25+2)==(28-1)`](http://dohliam.github.io/yub/?calc%20(25%2B2)%3D%3D(28-1))	test equivalence
* [`calc ~32.56`](http://dohliam.github.io/yub/?calc%20~32.56)	round numbers
* [`rand 550`](http://dohliam.github.io/yub/?rand 550)	return a random number between 0-550
* [`rand site`](http://dohliam.github.io/yub/?rand site)	go to random website
* [`rand img`](http://dohliam.github.io/yub/?rand img)	show a random image
* [`rand git`](http://dohliam.github.io/yub/?rand git)	visit a random GitHub project
* [`watch bollywood`](http://dohliam.github.io/yub/?watch ninja cat)	watch an embedded playlist of YouTube video results for the search term "ninja cat"
* [`link flint tigers`](http://dohliam.github.io/yub/?link flint tigers)	get a permalink to the command _flint tigers_ (which searches flickr for pictures of tigers sorted by "interestingness")
* [`fspell sometext`](http://dohliam.github.io/yub/?fspell sometext)	write out _sometext_ with flickr images
* [`ascii sometext`](http://dohliam.github.io/yub/?ascii sometext)	write out _sometext in ascii art
* [`where gn`](http://dohliam.github.io/yub/?where gn)	show the keyword and default search addresses for the command _gn_
* [`> am Alice in Wonderland`](http://dohliam.github.io/yub/?%3E%20am%20Alice%20in%20Wonderland)	go directly to the first Google search result for the term "Alice in Wonderland" on Amazon.com
* [`> wpde Turing complete`](http://dohliam.github.io/yub/?%3E%20wpde%20Turing%20complete)	read the article on "Turing completeness" in the _German_ Wikipedia
* [`cat engadget.com`](http://dohliam.github.io/yub/?cat engadget.com)	displays a text-only version of the webpage at engadget.com
* [`pop bbc gn yn bn`](http://dohliam.github.io/yub/?pop gn yn bn bbc)	pop up individual tabs with BBC News , Google News, Yahoo News, and Bing News, all in one command
* [`pop gim yim bim -t horses`](http://dohliam.github.io/yub/?pop gim yim bim -t horses)	pop up new tabs showing results of an image search for horses on Google, Yahoo, and Bing
...
Things you can expect to find in engines.js are: major search engines (Google, Yahoo, Bing... etc) and their various associated products (images, video, maps, news, weather, machine translation), [Wikipedia](http://dohliam.github.io/yub/?wp) and its various Wikimedia sister sites ([Wiktionary](http://dohliam.github.io/yub/?wt), [Wikiquote](http://dohliam.github.io/yub/?wq), [Wikinews](http://dohliam.github.io/yub/?wn)... etc), a selection of major news organizations ([BBC](http://dohliam.github.io/yub/?bbc), [Deutsche Welle](http://dohliam.github.io/yub/?dw), [France 24](http://dohliam.github.io/yub/?fr24en)... etc), major webmail providers (Gmail, Yahoo, Hotmail... etc), documentation for several popular scripting languages ([Bash](http://dohliam.github.io/yub/?sh), [JS](http://dohliam.github.io/yub/?js), [PHP](http://dohliam.github.io/yub/?php), [Python](http://dohliam.github.io/yub/?py), [Ruby](http://dohliam.github.io/yub/?rb)), and a bunch of other useful sites and tools ([Down For Everyone Or Just Me?](http://dohliam.github.io/yub/?isup), [Whois](http://dohliam.github.io/yub/?whois), [What Is My Ip?](http://dohliam.github.io/yub/?ip)... etc). A more detailed guide can be found in the wiki.
...
* International and local versions of the default websites in engines.js
  * For example, _all_ (as of this writing) international Google sites (including [Google British Indian Ocean Territory](http://dohliam.github.io/yub/?gio) and [Google Pitcairn Islands](http://dohliam.github.io/yub/?gpn)...)
...
* jukebox feature (like [`watch`](http://dohliam.github.org/yub/?whatis watch), but for music)
* pipes!
...
Development has proceeded on a strictly itch-scratching basis, with new functionality being added when and as actually needed. From very early on, yub.js became something of its own development environment, and there are built-in reference tools for [JavaScript](http://dohliam.github.io/yub/?s js) (as well as [other popular scripting languages](http://dohliam.github.io/yub/?s documentation)), [linters](http://dohliam.github.io/yub/?whatis jshint) and an [internal command creation syntax](http://dohliam.github.io/yub/?whatis create) that have helped to make common development-related tasks much easier.
