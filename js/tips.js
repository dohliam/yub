var tips = [
  ...
  {"n":"create ", "d":"Create a new YubSearch command"},
  {"n":"create <i>command</i>", "d":"Create a new YubSearch command called <i>command</i>"},
  ...
  {"n":"create <i>command name</i>", "d":"Create a new command called <i>command name</i>; will alert if command already exists"},
